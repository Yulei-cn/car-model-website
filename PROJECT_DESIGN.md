...
- 每个版本都有正面和反面。
- 只保留微信二维码位置，不放收款码。
- 同时保留网页预览和本地单独打印文件：`明信片/1-5/正面.html`、`明信片/1-5/反面.html`。
- 已导出图片文件：`明信片/1-5/正面.png`、`明信片/1-5/反面.png`。
- 完全 AI 生成素材的正向/反向关键词写在 `AI生成关键词.txt`。
...
- 海报为单面设计。
- A4 和 A6 各 5 个版本。
- 已嵌入网站二维码：`assets/qr/site-qrcode.png`。
- 本地单独打印文件：`海报A4/1-5/海报.html`、`海报A6/1-5/海报.html`。
- 已导出图片文件：`海报A4/1-5/海报.png`、`海报A6/1-5/海报.png`。
- 完全 AI 生成素材的正向/反向关键词写在 `AI生成关键词.txt`。
